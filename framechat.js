...
#confirmReportPopup {
  pointer-events: none; /* não intercepta cliques enquanto invisível */
}
#confirmReportPopup.active {
  pointer-events: auto; /* volta a funcionar quando abrir de verdade */
}
...
.message.new-message {
  animation: subtle-bounce 0.4s forwards;
}
...
.media-request.sent, .call-invite.sent {
  align-self: flex-end;
  background: var(--accent-color);
  color: #fff;
  border-bottom-right-radius: 4px;
...
#confirmReportPopup .buttons {
  display: flex;
  gap: 10px;
}

#confirmReportPopup button {
  flex: 1;
  padding: 10px;
  border-radius: 12px;
  font-weight: 600;
...
<div id="chatView">
  <div class="chat-header">
    ...
    <div class="chat-icons">
      ...
      <svg class="more-menu" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><circle cx="12" cy="5" r="2"/><circle cx="12" cy="12" r="2"/><circle cx="12" cy="19" r="2"/></svg>
      <svg class="refresh-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M13.5 2c-.83 0-1.5.67-1.5 1.5 0 .83.67 1.5 1.5 1.5s1.5-.67 1.5-1.5c0-.83-.67-1.5-1.5-1.5zm0 2c-.28 0-.5-.22-.5-.5s.22-.5 .5-.5 .5 .22 .5 .5-.22 .5-.5 .5zm6.09 1.97l-1.41-1.41c-.2-.2-.51-.2-.71 0l-5.58 5.58c-.2 .2-.2 .51 0 .71l1.41 1.41c.2 .2 .51 .2 .71 0l5.58-5.58c.2-.2 .2-.51 0-.71zm-2.83 0l4.95 4.95c.2 .2 .2 .51 0 .71l-1.41 1.41c-.2 .2-.51 .2-.71 0l-4.95-4.95c-.2-.2-.2-.51 0-.71l1.41-1.41c.2-.2 .51-.2 .71 0zM4 12c0-4.42 3.58-8 8-8 1.85 0 3.55 .63 4.9 1.69l1.51-1.51C17.5 2.81 14.92 2 12 2 6.48 2 2 6.48 2 12h2zm8 8c-1.85 0-3.55-.63-4.9-1.69l-1.51 1.51C6.5 21.19 9.08 22 12 22c5.52 0 10-4.48 10-10h-2c0 4.42-3.58 8-8 8z"/></svg>
    </div>
  </div>
  <div id="messages"></div>
  <div id="inputArea">
...
<div id="moreMenuPopup">
  <ul>
    <li id="reportBtn">
      <svg viewBox="0 0 24 24"><path d="M12 2L1 21h22L12 2zm0 3.84L20.73 19H3.27L12 5.84zM11 9h2v6h-2V9zm0 8h2v2h-2v-2z"/></svg>
      Denunciar
    </li>
    <li id="adBtn">
...
<div id="confirmReportPopup" class="popup">
  <p>Deseja enviar uma denúncia?</p>
  <div class="buttons">
...
const confirmReportPopup = document.getElementById('confirmReportPopup');
...
const profiles = [
  { name: 'Letícia Reed', photo: 'https://framerusercontent.com/images/iGsZV81bLARO3rxg0B5S88J4GQU.jpg', verified: true, snippet: 'Oi lindo, vem pro meu chat...', time: 'agora mesmo', paymentLink: 'https://app.pushinpay.com.br/service/pay/9FF819FB-2D06-45C4-BD8C-8217A997FBEA', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/leticiareed', massMessages: [{text: 'Oi lindo, tudo bem?', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Duda Brunet', photo: 'https://framerusercontent.com/images/FoK1KaGDLlF2436osMfHCSU9k.webp', verified: true, snippet: 'Ei môo, bem vindo! Animada pra te provocar hoje... Vamos brincar? 💋', time: 'set 20', paymentLink: 'https://app.pushinpay.com.br/service/pay/9ff97790-e6fa-4069-9138-c0cfad86a3bf', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/dudabrunet', massMessages: [{text: 'já coneferiu meu anúncio? só clicar ali em cima nos 3 pontinhos!', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Bianca Novelino', photo: 'https://framerusercontent.com/images/rVENuOaqP10FhfIg14tMT2EHFw.jpg', verified: true, snippet: 'Olha oq eu preparei pra você safado... 🔥', time: 'set 24', paymentLink: '', status: 'Vista por último há 1 dia', callPaymentLink: '', adLink: 'https://frameag.com/biancanovelino', massMessages: [{text: 'Posso te ligar? me envia o convite', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Brenda Trindade', photo: 'https://framerusercontent.com/images/AoXpk0CaadrGaZbN6hglCGqet0.jpg', verified: true, snippet: 'Preparado pra passar o mês gozando pras putarias que eu apronto? hahah 🫣💗', time: 'set 21', paymentLink: '', status: 'Esteve online há 15 minutos', callPaymentLink: 'https://app.pushinpay.com.br/service/pay/9ffa4c54-9989-47ae-9f0d-529648dd4116', adLink: 'https://frameag.com/brendatrindade', massMessages: [{text: 'não vai querer nossa chamadinha?', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Mafe Esper', photo: 'https://framerusercontent.com/images/7PQbvug8ntTrX7ryp6PFIWVxUs.png?scale-down-to=1024&width=828&height=1060', verified: true, snippet: 'Ei gato, tô louca pra te mostrar minhas curvas... 😏', time: 'Ontem', paymentLink: '', status: 'Vista por último há 1 dia', callPaymentLink: '', adLink: 'https://frameag.com/mafe-esper', massMessages: [{text: 'Desistiu de ver minhas curvas é?', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Giulia Rosa', photo: 'https://framerusercontent.com/images/HIZ0S8WRrxoPtNqwPBKHr31cd8.jpg', verified: true, snippet: 'oiee! tudo bem? se vc quer ficar mais próximo de mim, assina meu perfil💕', time: 'agora mesmo', paymentLink: '', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/ad-criadora', massMessages: [{text: 'ei, vamos papearrr haha tô on', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: ''}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: '', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Karol Rosalin', photo: 'https://framerusercontent.com/images/8iJ8hEUzmxwPCZokvXip2PKTsg.jpg', verified: true, snippet: 'se você entrar no meu chat agora, te envio o video que todos se apaixonaram! enfiei o consolo na bucetinha...', time: 'agora mesmo', paymentLink: 'https://app.pushinpay.com.br/service/pay/9ff8346a-86d5-4245-933b-8dfb3a73f786', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/ad-criadora', massMessages: [{text: 'quero te fazer gozar gostoso, volta pra mim?', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Amanda Marques', photo: 'https://framerusercontent.com/images/2fTHZ5jLhaulXi7DvHqshLsxY.webp', verified: true, snippet: 'Se tu está afim de um papo casual, tá no lugar certo. Me chama aqui no chat!', time: 'agora mesmo', paymentLink: '', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/ad-criadora', massMessages: [{text: 'Tá por ai? hahah', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
  { name: 'Fer Campos', photo: 'https://framerusercontent.com/images/ZCRA7b9vR75ENJfJnFlsbmj0xnQ.jpg', verified: true, snippet: 'Vem ver o que o menino n*y viu hahah tudo rosinha e pronto pra você🤤', time: 'agora mesmo', paymentLink: 'https://app.pushinpay.com.br/service/pay/9ff9eed1-b7b2-41c0-928e-eb479a229c56', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/ad-criadora', massMessages: [{text: 'Vem ser VIP', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
{ name: 'Mel Flores', photo: 'https://framerusercontent.com/images/DsexBAdBTMa5ouShBPIYcJhr8.jpeg', verified: true, snippet: 'Aqui dentro você é muito mais felizzz! Tenho certeza que serei a sua ruiva favorita 👩‍🦰🌪️', time: 'agora mesmo', paymentLink: '', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/ad-criadora', massMessages: [{text: 'Vem cá gatinho', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] },
{ name: 'Paola Anjinha', photo: 'https://framerusercontent.com/images/g4NsyEvYf5iLgh5rPUmRYJMJvi0.jpeg', verified: true, snippet: 'Oiêê… Cuidado: você pode se perder tentando entender se quer me usar ou me amar 🤭✨ Aqui vc tem meus vídeos mais íntimos e tô sempre online, pronta pra brincar com você 🔥 Faço pedidos e vídeos customizados aqui no chat… deixa eu ser sua safada preferida?', time: 'agora mesmo', paymentLink: '', status: 'Online agora', callPaymentLink: '', adLink: 'https://frameag.com/ad-criadora', massMessages: [{text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'text'}, {text: 'Oi amor, desistiu de mim?', delay: 3600000, type: 'free-photo', photoUrl: 'url-editavel.jpg'}, {text: 'Desbloqueie isso!', delay: 7200000, type: 'paid-media', previewUrl: 'preview.jpg', paymentLink: 'novo-link-upsell.com', price: 'R$ 50,00'}] }
];
...
function saveChatHistory() {
  ...
  const history = Array.from(messages.children).map(child => child.outerHTML);
  localStorage.setItem(`chat_${profileName}`, JSON.stringify(history.slice(-90)));
}

function loadChatHistory(profile) {
  try {
    const saved = localStorage.getItem(`chat_${profile.name}`);
    if (saved) {
      const history = JSON.parse(saved);
      history.forEach(html => {
        const tempDiv = document.createElement('div');
        tempDiv.innerHTML = html;
        messages.appendChild(tempDiv.firstChild);
      });
      return true;
    }
  } catch (e) {
    showToast('Erro ao carregar seu histórico. limpando...', 'error');
    localStorage.clear();
    return false;
  }
  return false;
...
function attachListeners() {
  messages.querySelectorAll('.unlock-btn').forEach(btn => {
    btn.addEventListener('click', showPaymentPopup);
  });
  messages.querySelectorAll('.accept-call-btn').forEach(btn => {
    btn.addEventListener('click', () => showCallDurationPopup(true));
  });
}
  ...
  const interval = setInterval(() => {
    if (index < texts.length) {
      ...
      if (window.isCallInvite) {
        ...
        sentCall.innerHTML = `
          <div class="call-title">Solicitação de chamada de vídeo</div>
        ...
        setTimeout(() => sentCall.classList.add('new-message'), 0);
...
function addMassMessage(profile, msg) {
  const now = Date.now();
  const interacted = localStorage.getItem(`interacted_${profile.name}`) === 'true';
  const lastInteraction = parseInt(localStorage.getItem(`lastInteraction_${profile.name}`) || '0');
  if (msg.delay === 0 || (interacted && (now - lastInteraction) >= msg.delay)) {
    let element;
    if (msg.type === 'text') {
      element = document.createElement('div');
      element.classList.add('message', 'received');
      element.innerHTML = `${msg.text}<div class="message-time">${getCurrentTime()}</div>`;
    } else if (msg.type === 'free-photo') {
      element = document.createElement('div');
      element.classList.add('message', 'received');
      element.innerHTML = `${msg.text || ''}<br><img class="media-preview" src="${msg.photoUrl}" alt="Free photo"><div class="message-time">${getCurrentTime()}</div>`;
    } else if (msg.type === 'paid-media') {
      element = document.createElement('div');
      element.classList.add('media-request');
      element.innerHTML = `
        <div class="media-title">Desbloquear mídia</div>
        <img class="media-preview" src="${msg.previewUrl}" alt="Mídia preview">
        <div class="media-caption">${msg.text}</div>
        <div class="media-price">${msg.price}</div>
        ...
        <div class="message-time">${getCurrentTime()} · ${msg.price} ainda não pago</div>
      `;
      element.querySelector('.unlock-btn').addEventListener('click', () => {
        window.currentPaymentLink = msg.paymentLink;
        showPaymentPopup();
      });
    }
    if (element) {
      messages.appendChild(element);
      setTimeout(() => element.classList.add('new-message'), 0);
      messages.scrollTop = messages.scrollHeight;
      saveChatHistory();
    }
  } else if (interacted) {
    const remaining = msg.delay - (now - lastInteraction);
    setTimeout(() => addMassMessage(profile, msg), remaining);
  }
}

function scheduleMassMessages(profile) {
  profile.massMessages.forEach(msg => {
    if (msg.delay === 0) {
      addMassMessage(profile, msg);
    } else {
      setTimeout(() => addMassMessage(profile, msg), 200);
    }
  });
}
...
function openChat(profile) {
  ...
  setTimeout(() => {
    ...
    if (!loadChatHistory(profile)) {
      ...
      setTimeout(() => initialMessage.classList.add('new-message'), 0);
      ...
      if (profile.name === 'Letícia Reed') {
        ...
        setTimeout(() => mediaRequest.classList.add('new-message'), 0);
      }
      ...
      if (profile.name === 'Brenda Trindade') {
        ...
        callInvite.innerHTML = `
          ...
          <img class="media-preview" src="https://framerusercontent.com/images/Zji6ePCM7zIKrItjEX69vyj5CLA.png" alt="Preview">
        ...
        setTimeout(() => callInvite.classList.add('new-message'), 0);
      }
  ...
  if (text) {
    try {
      ...
      setTimeout(() => {
        ...
        setTimeout(() => sentMessage.classList.add('new-message'), 0);
        messages.scrollTop = messages.scrollHeight;
        messageInput.value = '';
        localStorage.setItem(`interacted_${window.currentProfile.name}`, 'true');
        localStorage.setItem(`lastInteraction_${window.currentProfile.name}`, Date.now().toString());
        ...
        setTimeout(() => {
          ...
          responseMessage.innerHTML = `Poxa, para receber sua mensagem e conversarmos, você deve ser Premium!<br><button class="inline-btn" onclick="window.location.href='https://frameag.com/premium'">Assinar agora</button><div class="message-time">${getCurrentTime()}</div>`;
          messages.appendChild(responseMessage);
          setTimeout(() => responseMessage.classList.add('new-message'), 0);
          messages.scrollTop = messages.scrollHeight;
          saveChatHistory();
        }, 5000);
        saveChatHistory();
...
function handleMediaUpload(inputElement) {
  ...
  inputElement.onchange = (e) => {
    ...
    if (file.size > maxSize) return showToast('Arquivo grande demais! Máx 5MB.', 'error');

    if (!file.type.startsWith('image/') && file.type !== 'image/gif') {
      return showToast('Oops! Aceitamos apenas imagens ou GIFs.', 'error');
    }
...
function confirmMedia() {
  ...
  setTimeout(() => sentMedia.classList.add('new-message'), 0);
  messages.scrollTop = messages.scrollHeight;
...
onlineToggle.addEventListener('click', () => {
  ...
  convItems.forEach(item => {
    const status = item.querySelector('.conv-status').textContent;
    item.style.display = onlineToggle.classList.contains('active') && status !== 'Online agora' ? 'none' : 'flex';
  });
});
  ...
  if (term) {
    ...
    setTimeout(() => {
      ...
      searchUpsell.innerHTML = `
        <p>Para ter acesso a filtros e buscas avançadas no FrameChat, você deve ser um usuário Premium!</p>
...
moreMenu.addEventListener('click', () => {
  moreMenuPopup.style.display = 'block';
  setTimeout(() => moreMenuPopup.style.opacity = 1, 0);
});

document.addEventListener('click', e => {
  if (!moreMenu.contains(e.target) && !moreMenuPopup.contains(e.target)) {
    moreMenuPopup.style.opacity = 0;
    setTimeout(() => moreMenuPopup.style.display = 'none', 300);
  }
});

reportBtn.addEventListener('click', () => {
  confirmReportPopup.classList.add('active');
});

adBtn.addEventListener('click', () => {
  showLoading(1000, 'Redirecionando para anúncio...');
  setTimeout(() => window.location.href = window.currentProfile.adLink, 1000);
});

supportBtn.addEventListener('click', () => {
  showLoading(1000, 'Redirecionando para suporte...');
  setTimeout(() => window.location.href = 'https://frameag.com/contato', 1000);
});

// Age Gate primeiro, pra não conflitar
...
if (agreeBtn) {
  agreeBtn.addEventListener('click', (e) => {
    e.stopPropagation(); // impede que outro listener capture o clique
...
if (exitBtn) {
  exitBtn.addEventListener('click', (e) => {
    e.stopPropagation();
    window.location.href = 'https://frameag.com/age-restriction';
  });
}

refreshIcon.addEventListener('click', () => {
  showToast('Recarregando chat...', 'info');
  messages.innerHTML = '';
  loadChatHistory(window.currentProfile);
  setTimeout(() => { messages.scrollTop = messages.scrollHeight; }, 0);
  attachListeners();
});

confirmYes.addEventListener('click', () => {
  confirmReportPopup.classList.remove('active');
  showLoading(2000, 'Processando denúncia...');
  setTimeout(() => window.location.href = 'https://frameag.com/report', 2000);
});
