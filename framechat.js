...
<div id="conversations">
  <h1>FrameChat<div style="position:relative">
      <img id="notifIcon" src="https://framerusercontent.com/images/Yr7purGR3rArCX8H8FMYR7b40.png" alt="Ícone de notificações" title="Ver notificções">
...
function openChat(profile) {
  ...
  setTimeout(() => {
    ...
    chatNameSpan.innerHTML = `${profile.name}${profile.verified ? '<img class="verified-badge" src="https://framerusercontent.com/images/jggVjcyAj9NcDFewbWWd70.png">' : ''}<div class="conv-status">${profile.status}</div>`;
    messages.innerHTML = '';
