...
#conversations {
  margin-top: 80px; /* Reduzido para melhor fit em mobile */
  padding: 15px;
  overflow-y: auto;
  flex: 1;
}
...
.conv-item {
  display: flex;
  align-items: center;
  flex-wrap: wrap; /* Adicionado para melhor wrap em telas estreitas */
  padding: 10px;
  border-radius: 16px;
  margin-bottom: 10px;
  background: var(--secondary-bg);
...
.conv-info {
  flex: 1;
  min-width: 0; /* Para permitir overflow correto */
}
