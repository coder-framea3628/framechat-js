...
<div id="ageGateOverlay">
  <div id="ageGatePopup">
    ...
    <div class="info">Para mais informações, consulte nossa <a href="https://frameag.com/privacy">Política de Privacidade</a> e <a href="https://frameag.com/termos">Termos da Frame</a></div>
  </div>
</div>
...
const profiles = [
  ...
  { name: 'Brenda Trindade', photo: 'https://framerusercontent.com/images/AoXpk0CaadrGaZbN6hglCGqet0.jpg', verified: true, snippet: 'Preparado pra passar o mês gozando pras putarias que eu apronto? hahah 🫣💗', time: 'set 21', paymentLink: '', status: 'Esteve online há 15 minutos' },
{ name: 'Giulia Rosa', photo: 'https://framerusercontent.com/images/HIZ0S8WRrxoPtNqwPBKHr31cd8.jpg', verified: true, snippet: 'oiee! tudo bem? aproveita pra assinar meus conteúdos e conversar comigo no chat', time: 'set 21', paymentLink: '', status: 'Esteve online há 5 minutos' },
...
{ name: 'Amanda Marques', photo: 'https://framerusercontent.com/images/2fTHZ5jLhaulXi7DvHqshLsxY.webp', verified: true, snippet: 'Se tu curte conversar além do sexual, tá lo lugar certo haha☺️ me chama aqui no chat!', time: 'Há 5min', paymentLink: '', status: 'Online agora' }
];
...
{ name: 'Alê Zambelli', photo: 'https://example.com/karol.jpg', verified: true, snippet: 'Vem conversar cmg amor', time: 'set 26' },
  { name: 'Thay Napoleão', photo: 'https://example.com/outra.jpg', verified: true, snippet: 'Mensagem exclusiva...', time: 'set 09' }
  ...
  setTimeout(() => {
    ...
    if (profile.name === 'Duda Brunet') {
      ...
      mediaRequest.innerHTML = `
        ...
        <div class="media-caption">Me manda uma fotinha, vc sabe do que... hahaha</div>
        <div class="media-price">R$ 79,99</div>
