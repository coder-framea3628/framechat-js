...
const profiles = [
  ...
  { name: 'Fer Campos', photo: 'https://framerusercontent.com/images/ZCRA7b9vR75ENJfJnFlsbmj0xnQ.jpg', verified: true, snippet: 'Vem ver o que o menino n*y viu hahah tudo rosinha e pronto pra você🤤', time: 'agora mesmo', paymentLink: '', status: 'Online agora' }
];
...
if (profile.name === 'Fer Campos') {
      messageContent += `<br><img class="media-preview" src="https://framerusercontent.com/images/e5SRSdlPORUkUtCCoYnBOziBzdA.jpeg" alt="Imagem">`;
    }
...
function handleMediaUpload(inputElement) {
  ...
  inputElement.onchange = (e) => {
    ...
    if (file.size > maxSize) return showToast('Arquivo muito grande (máx 5MB).');

    if (!file.type.startsWith('image/') && file.type !== 'image/gif') {
      return showToast('Formato inválido. Envie imagem ou GIF.');
    }
