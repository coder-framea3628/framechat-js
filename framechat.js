...
const profiles = [
  ...
  { name: 'Duda Brunet', photo: 'https://framerusercontent.com/images/FoK1KaGDLlF2436osMfHCSU9k.webp', verified: true, snippet: 'Ei môo, bem vindo! Animada pra te provocar hoje... Vamos brincar? 💋', time: 'set 20', paymentLink: 'https://app.pushinpay.com.br/service/pay/9ff97790-e6fa-4069-9138-c0cfad86a3bf', status: 'Online agora' },
  { name: 'Bianca Novelino', photo: 'https://framerusercontent.com/images/rVENuOaqP10FhfIg14tMT2EHFw.jpg', verified: true, snippet: 'Olha oq eu preparei pra você safado... 🔥', time: 'set 24', paymentLink: '', status: 'Vista por último há 1 dia' },
  ...
  { name: 'Mafe Esper', photo: 'https://framerusercontent.com/images/7PQbvug8ntTrX7ryp6PFIWVxUs.png', verified: true, snippet: 'Ei gato, tô louca pra te mostrar minhas curvas... 😏', time: 'Ontem', paymentLink: '', status: 'Vista por último há 1 dia' },
{ name: 'Giulia Rosa', photo: 'https://framerusercontent.com/images/7PQbvug8ntTrX7ryp6PFIWVxUs.png', verified: true, snippet: 'oiee, tudo bem? se quiser mtt conteúdo exclusivo, assina meu perfil', time: 'Ontem', paymentLink: '', status: 'Vista por último há 5min' },
  { name: 'Karol Rosalin', photo: 'https://framerusercontent.com/images/8iJ8hEUzmxwPCZokvXip2PKTsg.jpg', verified: true, snippet: 'se você entrar no meu chat agora, te envio o video que todos se apaixonaram! enfiei o consolo na bucetinha...', time: 'agora mesmo', paymentLink: 'https://app.pushinpay.com.br/service/pay/9ff8346a-86d5-4245-933b-8dfb3a73f786', status: 'Online agora' }
{ name: 'Amanda Marques', photo: 'https://framerusercontent.com/images/2fTHZ5jLhaulXi7DvHqshLsxY.webp', verified: true, snippet: 'Se tu gosta de conversas casuais e se conectar antes de tudo, me chama aqui no chat☺️ te aguardo!', time: 'Ontem', paymentLink: '', status: 'Vista por último há 1 hora' }
];

// Perfis blurred (exemplo com Karol Rosalin e mais)
const blurredProfiles = [
  { name: 'Thay Napoleão', photo: 'https://framerusercontent.com/images/tJ3AgnQF3cyHSAg0ecasmAQSDE.jpg', verified: true, snippet: 'Vídeo inédito! Gozando gostoso...', time: 'set 24' },
{ name: 'Lari Hammer', photo: 'https://framerusercontent.com/images/VCpz53J6C65xCjC0QSXKdywSRA.jpg', verified: true, snippet: 'No meu OF tem mta coisa gostosa', time: 'set 24' },
  { name: 'Aline Ferraz', photo: 'https://example.com/outra.jpg', verified: true, snippet: 'Mensagem exclusiva...', time: 'set 10' },
{ name: 'Luiza Melanco', photo: 'https://example.com/outra.jpg', verified: true, snippet: 'Vamos gozar?', time: 'set 10' },
{ name: 'Fernanda Campos', photo: 'https://framerusercontent.com/images/ZCRA7b9vR75ENJfJnFlsbmj0xnQ.jpg', verified: true, snippet: 'Vem ver o que o menino Ney viu hahah', time: 'set 24' },
...
// Adicionar solicitação de mídia para Duda
    if (profile.name === 'Duda Brunet') {
      ...
      mediaRequest.innerHTML = `
        ...
        <div class="media-caption">Me mostra, vc sabe bem oq é hahaha</div>
        <div class="media-price">R$ 79,99</div>
...
function confirmMedia() {
  ...
  sentMedia.innerHTML = `
    ...
    <img class="media-preview" src="${mediaPreview.src}" alt="Sua mídia">
  ...
  if (term) {
    ...
    setTimeout(() => {
      ...
      searchUpsell.innerHTML = `
        <p>Para ter acesso a filtros e buscas avançadas, você deve ser Premium!</p>
...
agreeBtn.addEventListener('click', () => {
  ...
  setTimeout(() => ageGateOverlay.style.display = 'none', 500);
});
