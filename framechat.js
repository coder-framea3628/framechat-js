...
const profiles = [
  ...
  { name: 'Giulia Rosa', photo: 'https://framerusercontent.com/images/HIZ0S8WRrxoPtNqwPBKHr31cd8.jpg', verified: true, snippet: 'oiee! tudo bem? se vc quer ficar mais próximo de mim, assina meu perfil💕', time: 'agora mesmo', paymentLink: '', status: 'Online agora' },
  ...
  { name: 'Amanda Marques', photo: 'https://framerusercontent.com/images/2fTHZ5jLhaulXi7DvHqshLsxY.webp', verified: true, snippet: 'Se tu está afim de um papo casual, tá no lugar certo. Me chama aqui no chat!', time: 'agora mesmo', paymentLink: '', status: 'Online agora' },
  { name: 'Fer Campos', photo: 'https://framerusercontent.com/images/ZCRA7b9vR75ENJfJnFlsbmj0xnQ.jpg', verified: true, snippet: 'Vem ver o que o menino n*y viu hahah tudo rosinha e pronto pra você🤤', time: 'agora mesmo', paymentLink: 'https://app.pushinpay.com.br/service/pay/9ff9eed1-b7b2-41c0-928e-eb479a229c56', status: 'Online agora' }
];
